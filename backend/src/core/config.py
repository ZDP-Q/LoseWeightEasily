...
class DatabaseSettings(BaseModel):
    url: str = Field(default="postgresql://postgres:password@localhost:5432/loss_weight")

class DataSettings(BaseModel):
    dir: str = Field(default="data")
    json_file: str = Field(default="FoodData_Central_foundation_food_json_2025-12-18.json")
